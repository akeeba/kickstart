...
class AKS3Configuration
{
     ...
     */
    function __construct($access, $secret, $singatureMethod = 'v4', $region = '')
    {
     ...
     *
     * @throws  AKS3InvalidAccessKey
     */
    public function setAccess($access)
    {
        if (empty($access))
        {
            throw new AKS3InvalidAccessKey;
        }
     ...
     *
     * @throws  AKS3InvalidSecretKey
     */
    public function setSecret($secret)
    {
        if (empty($secret))
        {
            throw new AKS3InvalidSecretKey;
        }
     ...
     *
     * @throws  AKS3InvalidSignatureMethod
     */
    public function setSignatureMethod($signatureMethod)
    {
        ...
        {
            throw new AKS3InvalidSignatureMethod;
        }
